...
// Picks whichever deadline (return window or warranty) is soonest, since that's the one the user
// needs to act on first. Ported from apps/mobile/src/lib/warrantyDisplay.ts.
